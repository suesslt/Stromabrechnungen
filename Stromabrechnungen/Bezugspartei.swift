...
final class Bezugspartei {
    ...
    /// Anteil als `Score.Percent` (Rule FW-16) — Anzeige und Faktor-Arithmetik
    /// laufen hierüber; gespeichert bleibt der Prozentwert 0–100.
    var anteilPercent: Percent {
        get { .of(anteil / 100) }
        set { anteil = newValue.displayValue }
    }
